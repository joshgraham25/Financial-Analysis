...
> **Source** by selecting the range your list sits in: `=$M$5:$M$10`. Works in
...
> `=$O$5#` with the dollar signs — a relative reference
...
> List → Source `=$O$5#`. The `#` means "and everything this formula spilled
